...
import { Box, Container, Typography, TextField, Button, Autocomplete } from '@mui/material';
...
const countryDialingCodes = [
    ...
    { code: "+245", country: "GW" }, { code: "+246", country: "IO" }, { code: "+248", country: "SC" },
    { code: "+249", country: "SD" }, { code: "+250", country: "RW" }, { code: "+251", country: "ET" },
    { code: "+252", country: "SO" }, { code: "+253", country: "DJ" }, { code: "+254", country: "KE" },
    { code: "+255", country: "TZ" }, { code: "+256", country: "UG" }, { code: "+257", country: "BI" },
    { code: "+258", country: "MZ" }, { code: "+260", country: "ZM" }, { code: "+261", country: "MG" },
    { code: "+262", country: "RE" }, { code: "+263", country: "ZW" }, { code: "+264", country: "NA" },
    { code: "+265", country: "MW" }, { code: "+266", country: "LS" }, { code: "+267", country: "BW" },
    { code: "+268", country: "SZ" }, { code: "+269", country: "KM" }, { code: "+290", country: "SH" },
    { code: "+291", country: "ER" }, { code: "+297", country: "AW" }, { code: "+298", country: "FO" },
    { code: "+299", country: "GL" }, { code: "+350", country: "GI" }, { code: "+351", country: "PT" },
    { code: "+352", country: "LU" }, { code: "+353", country: "IE" }, { code: "+354", country: "IS" },
    { code: "+355", country: "AL" }, { code: "+356", country: "MT" }, { code: "+357", country: "CY" },
    { code: "+358", country: "FI" }, { code: "+359", country: "BG" }, { code: "+370", country: "LT" },
    { code: "+371", country: "LV" }, { code: "+372", country: "EE" }, { code: "+373", country: "MD" },
    { code: "+374", country: "AM" }, { code: "+375", country: "BY" }, { code: "+376", country: "AD" },
    { code: "+377", country: "MC" }, { code: "+378", country: "SM" }, { code: "+379", country: "VA" },
    ...
    { code: "+508", country: "PM" }, { code: "+509", country: "HT" }, { code: "+590", country: "GP" },
    ...
    return (
        <Box sx={{ minHeight: 'calc(100vh - 64px)', display: 'flex', alignItems: 'center', py: { xs: 5, md: 8 } }}>
            <Container maxWidth="sm">
                ...
                <Typography variant="h5" sx={{ color: '#50565e', lineHeight: 1.6, mb: { xs: 3, sm: 4 }, fontSize: { xs: '1.1rem', sm: '1.5rem' } }}>
                    Have questions? We'd love to hear from you. Send us a message and we'll respond as soon as possible.
                </Typography>
                <Box component="form" sx={{ display: 'flex', flexDirection: 'column', gap: { xs: 2.5, sm: 3 } }}>
                    <TextField label="Name" variant="outlined" fullWidth />
                    <TextField label="Email Address" variant="outlined" type="email" fullWidth />
                    <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, gap: { xs: 2.5, sm: 2 } }}>
                        <Autocomplete
                            options={countryDialingCodes}
                            getOptionLabel={(option) => option.code}
                            defaultValue={countryDialingCodes[0]}
                            disableClearable
                            autoHighlight
                        ...
                        />
                        <TextField label="Mobile Number" variant="outlined" type="tel" fullWidth />
                    </Box>
                    <TextField label="Message" variant="outlined" multiline rows={4} fullWidth />
                    <Button variant="contained" size="large" sx={{ backgroundColor: '#4299E1', borderRadius: '20px', textTransform: 'none', '&:hover': { backgroundColor: '#3182ce' } }}>
                        Submit
                    </Button>
                </Box>
            </Container>
